export const OFFICERS_2025_2026 = [
    ...
    { name: "Melgen II A. Simo", position: "Treasurer", role: "executive" },
    { name: "Jacky L. Rapal", position: "Assistant Treasurer", role: "executive" },
    { name: "Pit Frankie B. Ceniza", position: "Assistant Auditor", role: "executive" },
    { name: "Samantha Cruspero", position: "Business Manager", role: "executive" },
    { name: "Adrian A. Hinayon", position: "Assistant Business Manager", role: "executive" },
    { name: "Chriss Laurence Olanda", position: "Public Information Officer", role: "executive" },
    { name: "Vanessa Denisse Ibañez", position: "1st Year Representative", role: "executive" },
    { name: "Moison Rayam Dominggo", position: "2nd Year Representative", role: "executive" },
